...
describe(CachingSplittingQuoteNode, () => {
  describe("quote", () => {
    it("works for 0 liquidity 1 token1 input", () => {
      const pool = new CachingSplittingQuoteNode(
        new PlainPool({
          token0: 0n,
          token1: 1n,
          tickSpacing: 0,
    ...
    it("eth usdc example pool", () => {
      ...
      const cachingNode = new CachingSplittingQuoteNode(plainPool, {
        resourcesReducer: plainPoolResourcesReducer,
      });
      const impreciseCachingNode = new CachingSplittingQuoteNode(plainPool, {
        resourcesReducer: plainPoolResourcesReducer,
        maxSplits: 8,
      });
...
{
  "calculatedAmount": 936197801222777856n,
  ...
  "stateAfter": {
    ...
    "sqrtRatio": 15872195687801699221544645874411462n,
  },
}
`);
      ...
      ).toMatchInlineSnapshot(`
{
  ...
  "stateAfter": {
    "activeTickIndex": 216,
    "liquidity": 1838637850921516n,
    "sqrtRatio": 15872128234587002928099306706795695n,
  },
}
`);
      ...
      ).toMatchInlineSnapshot(`
{
  ...
  "stateAfter": {
    "activeTickIndex": 327,
    "liquidity": 10987751870970n,
    "sqrtRatio": 376460041487888663062826364698432000n,
  },
}
`);
      ...
      ).toMatchInlineSnapshot(`
{
  ...
  "stateAfter": {
    ...
    "sqrtRatio": 15351710788920282821230592999569642n,
  },
}
`);
      expect(
      ...
      ).toMatchInlineSnapshot(`
{
  ...
  "stateAfter": {
    "activeTickIndex": 205,
    "liquidity": 3707980262711434n,
    "sqrtRatio": 15351715437192922710342234939390435n,
  },
}
`);
      ...
      ).toMatchInlineSnapshot(`
{
  ...
  "stateAfter": {
    ...
    "sqrtRatio": 14632357786369744004390418248017976n,
  },
}
`);
      ...
      ).toMatchInlineSnapshot(`
{
  ...
  "stateAfter": {
    "activeTickIndex": 189,
    "liquidity": 20066300368579088n,
    "sqrtRatio": 14632358990032634961421813119896951n,
  },
}
`);
...
`);
    ...
    it("eth dai example pool", () => {
      const node = new CachingSplittingQuoteNode(
        new PlainPool({
          token0: 0n,
          token1: 1n,
          tickSpacing: 0,
